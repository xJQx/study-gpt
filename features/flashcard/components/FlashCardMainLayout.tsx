    ...
    setQuestions([
      {
        ...
        answer:
          'Ac ut consequat semper viverra nam libero justo laoreet sit. Libero nunc consequat interdum varius sit amet mattis vulputate enim. Sapien et ligula ullamcorper malesuada proin libero nunc. Tincidunt dui ut ornare lectus sit.'
      },
      {
        question:
          'Suspendisse potenti nullam ac tortor vitae purus faucibus ornare?',
        answer:
          'Magna fringilla urna porttitor rhoncus dolor purus non enim praesent. Lectus nulla at volutpat diam ut venenatis. Urna id volutpat lacus laoreet.'
      }
    ]);
